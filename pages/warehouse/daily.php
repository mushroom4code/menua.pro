...
if (!isset($_GET['date'])) {
	?>
	<input type="date" onchange="window.location.href = `/pages/warehouse/daily.php?date=${this.value}`">
	<?
} else {
...
WHERE
    `WH_goodsOutDate` >= '" . $_GET['date'] . " 00:00:00'
        AND `WH_goodsOutDate` <= '" . $_GET['date'] . " 23:59:59'
